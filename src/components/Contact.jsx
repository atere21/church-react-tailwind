...
const Contact = () => {
  return (
    <div name="contact" className="max-w-[1140px] m-auto w-full p-4 py-16">
      ...
      <p className="text-center py-2 text-blue-700 font-bold">
        We're standing by!
      </p>
      <div className="grid md:grid-cols-2">
        ...
        <form action="https://getform.io/f/DbDGjyal" method="POST">
          <div className="grid grid-cols-2">
            ...
            />
            <textarea
              className="border col-span-2 m-2 p-2 resize-none"
              name="textarea"
              cols="30"
              rows="10"
            ></textarea>
