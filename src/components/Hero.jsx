      ...
      <div className="ml-[5%] grid md:flex">
        ...
        <div className="imagesdiv grid relative mt-20">
          <div className="grid grid-cols-2 grid-rows-6 h-[200vh] ">
            <img
              className="row-span-1 object-cover p-2 w-full h-full z-10"
              src={image1}
              alt="/"
            />
            <img
              className="row-span-2 object-cover p-2 w-full h-full z-10 relative"
              src={image3}
              alt="/"
            />
            <img
            ...
            />
            <img
              className="absolute bottom-[72%] left-[18%] transform translate-x-[-50%] translate-y-[50%] z-0 hidden md:block"
              src={pointer2}
              alt="pointer2"
            />
            <img
              className="absolute bottom-[92%] left-[60%] transform translate-x-[-50%] translate-y-[50%] z-0 hidden md:block"
              src={pressing2}
              alt="pointer2"
            />
          </div>
